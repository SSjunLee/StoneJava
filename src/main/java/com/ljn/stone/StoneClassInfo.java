...
public class StoneClassInfo {
    private ClassStmt classDef;
    private StoneClassInfo parent;
    private Env env;
    ...
    public String name(){return classDef.name();}
    public ClassBody body(){return classDef.body();}
    public StoneClassInfo superClass() {return parent;}
